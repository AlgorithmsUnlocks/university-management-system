...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-end mb-4">
                        ...
                        <h1 class="h4 mb-0 text-success">Faculty Member of BBA</h1>
                          <!-- Page Heading  
    ...
    <div class="card shadow mb-4 ">
        ...
        <h6 class="m-0 font-weight-bold text-success text-center">All Teacher of BBA Department</h6>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['teacher_eamil']; ?></td>
                        ...
                        <td>
                             ...
                             <form action="bba_teacher_view.php" method="post">
