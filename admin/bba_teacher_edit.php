        ...
        ?>
            ...
            <?php 
                ...
                if(isset($_POST['edit_btn'])){
                    $id = $_POST['edit_id'];
                    $query = "SELECT * FROM `bba_teacher` WHERE id = '$id'";
                    ...
                    {
                        ?>
                         <form action="b_action.php" method="POST" enctype="multipart/form-data">
                         ...
                         <a href='bba_teacher.php'><button type='submit' class='btn btn-primary '> CANCEL </button></a>
                         </div>
