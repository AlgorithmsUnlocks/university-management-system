...
if(!empty($teacher_name) && !empty($teacher_title) && !empty($teacher_eamil) && !empty($teacher_cell) &&!empty($education_bg) && !empty($conduct_course) && !empty($teacher_photo)){
    ...
    $query = "INSERT INTO `islamic_teacher`(`teacher_name`, `teacher_title`, `teacher_eamil`, `teacher_cell`, `education_bg`, `conduct_course`, `teacher_photo`) VALUES ('$teacher_name','$teacher_title','$teacher_eamil','$teacher_cell','$education_bg','$conduct_course','$image_des')";
    ...
    if($query_run){
        ...
        header('Location: islamic_teacher.php');
    }
    else{
...
if(isset($_POST['update_btn'])){
    ...
    $query = "UPDATE `islamic_teacher` SET `teacher_name`='$teacher_name',`teacher_title`='$teacher_title',`teacher_eamil`='$teacher_eamil',`teacher_cell`='$teacher_cell',`education_bg`='$education_bg',`conduct_course`='$conduct_course',`teacher_photo`='$image_des' WHERE id = '$id'";
...
if(isset($_POST['delete_btn'])){
    $id = $_POST['delete_id'];
    $query = "DELETE FROM `islamic_teacher` WHERE `id`= '$id' ";
    $query_run = mysqli_query($db_conn,$query);
    if($query_run){
