...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-end mb-4">
                        ...
                        <h1 class="h4 mb-0 text-success">Faculty Member of Islamic Studies Engineering</h1>
                          <!-- Page Heading  
    ...
    <div class="container">
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="islamic_action.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="card shadow mb-4 ">
        ...
        <h6 class="m-0 font-weight-bold text-success text-center">All Teacher of Islamic Studies Department</h6>
    ...
    <?php 
        $query = "SELECT * FROM `islamic_teacher`";
                    ...
                    <tr>
                       ...
                       <td><?php echo $row['teacher_eamil']; ?></td>
                        ...
                        <td>
                             ...
                             <form action="islamic_teacher_view.php" method="post">
                             ...
                             <hr>
                             <form action="islamic_action.php" method="post">
                        ...
                        echo "<h2 class='bg-warning text-center text-white'>No Teacher Found in Islamic</h2>";
                     }
                     ?>
