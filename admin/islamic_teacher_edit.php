        ...
        ?>
            ...
            <?php 
                ...
                if(isset($_POST['edit_btn'])){
                    $id = $_POST['edit_id'];
                    $query = "SELECT * FROM `islamic_teacher` WHERE id = '$id'";
                    ...
                    foreach($query_run as $row)
                    {
                        ?>
                         <form action="islamic_action.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="textarea" class='form-control' name='conduct_course' placeholder='Conduct Courses' value="<?php echo $row['conduct_course']; ?>">
                                <?php /*
                         ...
                         <a href='islamic_teacher.php'><button type='submit' class='btn btn-primary '> CANCEL </button></a>
                         </div>
